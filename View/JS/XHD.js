...
function checkcr() {
    var copyrighttxt = '\u0026\u0023\u0031\u0036\u0039\u003b\u0032\u0030\u0031\u0035\u0020\u0026\u006c\u0074\u003b\u0061\u0020\u0068\u0072\u0065\u0066\u003d\u0026\u0071\u0075\u006f\u0074\u003b\u0068\u0074\u0074\u0070\u003a\u002f\u002f\u0077\u0077\u0077\u002e\u0078\u0068\u0064\u0063\u0072\u006d\u002e\u0063\u006f\u006d\u0026\u0071\u0075\u006f\u0074\u003b\u0020\u0074\u0061\u0072\u0067\u0065\u0074\u003d\u0026\u0071\u0075\u006f\u0074\u003b\u005f\u0062\u006c\u0061\u006e\u006b\u0026\u0071\u0075\u006f\u0074\u003b\u0026\u0067\u0074\u003b\u9ec4\u6da6\u4f1f\u0026\u006c\u0074\u003b\u002f\u0061\u0026\u0067\u0074\u003b\u0020\u0020\u7248\u6743\u6240\u6709\u0020\u0076\u0031\u002e\u0031\u0037';
    if ($("div [position=bottom]").html() != copyrighttxt)
        $("div [position=bottom]").html(myHTMLDeCode(copyrighttxt));
}
...
function view(type, id, id1) {
    var width = 100, height = 50, title = '', url = '', showMax = true;
    switch (type) {
        case "customer":
            width = 770, height = 490, title = "客户详情", url = "CRM/Customer/Customer_view.aspx?id=" + id;
            break;
        case "follow":
            width = 630, height = 400, title = "查看跟进", url = "CRM/contact/Customer_follow_add.aspx?id=" + id;
            break;
        case "contact":
        ...
        case "contract":
            ...
            break;
        case "invoice":
            width = 770, height = 490, title = "查看发票", url = "finance/invoice_add.aspx?id=" + id;
            break;
        case "emp":
            width = 770, height = 490, title = "查看员工", url = 'HR/hr_employee_add.aspx?empid=' + id;
            break;
        case "task":
            width = 770, height = 450, title = "查看任务", url = 'personal/task/Assignment_add.aspx?id=' + id;
            break;
        case "sms":
...
function f_qq(QQ) {
    //var url = "http://wpa.qq.com/msgrd?v=3&uin=" + QQ + "&site=qq&menu=no";
    var url = "tencent://message/?uin=" + QQ + "&Site=-&Menu=no";
...
function setColumn(type, menuID, columnID, value) {
    $.ajax({
        url: "Sys_user_table.setColumn.xhd",
        type: "POST",
        data: { type: type, MenuID: menuID, columnID: columnID, value: value, rnd: Math.random() },
...
function CK_UE_Name(UE, id, name) {
    var content = UE.getEditor('editor').getContent();
    var html = $(content);

    var check = true;
    $(":input", html).each(function (i, item) {
        var input_id = $(this).attr("id");
        var input_name = $(this).attr("xname");

        if (input_id != id && input_name == name)
            check = false;
    });
    return check;
