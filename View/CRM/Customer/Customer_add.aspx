                        ...
                        fields: [
                            {
                                ...
                                rows: [
                                    ...
                                    [
                                        { display: "客源状态", name: "T_private", type: "select", options: "{width:180,data:[{id:0,text:'私客'},{id:1,text:'公客'}],selectBoxHeight:50,value:'" + obj.isPrivate + "'}", validate: "{required:true}" },
