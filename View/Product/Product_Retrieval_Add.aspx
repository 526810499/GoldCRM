        ...
        function loadForm(oaid) {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    rows.push(
                            [
                               { display: "克重", name: "T_weight", type: "number", validate: "{required:true}", initValue: toMoney(obj.weight) },
                            ],
                            [
                                { display: "数量", name: "T_number", type: "digits", validate: "{required:true}", initValue: (obj.number) }
                            ],
                            [
