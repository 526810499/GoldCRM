...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var url = "Product.grid.xhd?status=" + status + "&SupplierID=" + SupplierID + "&depdata=" + getparastr("depdata", "") + "&sindep_id=" + getparastr("depid", "");
            $("#maingrid4").ligerGrid({
                columns: [
        ...
        function doserch() {
            ...
            var serchtxt = "depdata=" + getparastr("depdata", "") + "&categoryid=" + cid + "&status=" + status +
                "&stext=" + $("#stext").val() + "&scode=" + $("#scode").val() +
                "&SupplierID=" + SupplierID + "&rnd=" + Math.random() + "&sindep_id=" + getparastr("depid", "");
