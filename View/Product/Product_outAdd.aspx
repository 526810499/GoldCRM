...
<head>
    ...
    <script type="text/javascript">
        ...
        function f_save() {
            ...
            if ($(form1).valid()) {
                var sendtxt = "T_todep_id_val=" + T_NowWarehouse_val + "&T_Remark=" + $("#T_Remark").val() + "&id=" + getparastr("id");
        ...
        function add() {
            f_openWindow("product/GetProduct2.aspx?status=1,2&optype=zbck", "手动添加商品", 1000, 400, f_getpost, 9003);
        }

 
        function addCode() {
            f_openWindow("product/GetCodeProduct.aspx?status=1,2&optype=zbck", "选择扫码商品", 1000, 400, f_getpost, 9003);
        }
