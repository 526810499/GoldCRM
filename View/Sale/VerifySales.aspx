    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                ...
                url: "Sale_order.gridData.xhd?saveorder=1&cwVerify=1&user=" + user + "&datacount=1&rnd=" + Math.random() + "&startdate=<%=DateTime.Now.AddDays(-1).Date%>",
        ...
        function exports() {
            ...
            var sendtxt = "&saveorder=1&etype=1&datacount=1&user=2&rnd=" + Math.random();
            var serchtxt = $("#serchform :input").fieldSerialize() + sendtxt;
