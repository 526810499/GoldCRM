    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    rows.push(
                        ...
                        [
                          { display: "状态", name: "T_VerifyStatus", type: "select", options: "{width:180,data:[{id:0,text:'已销售'},{id:1,text:'已核销'}],selectBoxHeight:50,value:'" + obj.VerifyStatus + "'}", validate: "{required:true}" },
                        ],
                        [
        ...
        function f_grid() {
            $("#maingrid4").ligerGrid({
                ...
                usePager: false,
                //enabledEdit: true,
                url: "Sale_order_details.grid.xhd?cwVerify=1&orderid=" + getparastr("id"),
                width: '100%',
                height: 350,
                heightDiff: -1,
            });
