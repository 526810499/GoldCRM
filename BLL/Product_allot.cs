...
namespace XHD.BLL
{
    ...
    {
        private readonly DAL.Product_allot dal = new DAL.Product_allot();
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.Product_allot> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.Product_allot> DataTableToList(DataTable dt)
        {
            List<Model.Product_allot> modelList = new List<Model.Product_allot>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Model.Product_allot model;
